	...
	if(id==0||id==""||id==null){
		...
		$.ajax({
			...
			success : function(data){
				...
				if(paymentEntity.terminalType=="web"){
					var HTML='<option value="web" selected>web</option>'+
					'<option value="wap">wap</option>';
					$('#terminalType').html(HTML);
				}else if(paymentEntity.terminalType=="wap"){
					var HTML='<option value="wap" selected>wap</option>'+
