...
<div style="overflow:hidden; font-family:'幼圆'">
    ...
    <div class="orderok_box">
	     <div class="success"><img id="successImg" class="img_box" src="${resourcePath }/image/payment/ico-wrong.png" width="48" height="48" /><p id="">交易失败！</p></div>
	     <div class="order_num" id="" style="color:red">您此次支付存在风险</div>
