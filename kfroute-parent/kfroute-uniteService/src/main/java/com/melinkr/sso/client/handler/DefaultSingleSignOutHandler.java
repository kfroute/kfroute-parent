package com.melinkr.sso.client.handler;
...
public final class DefaultSingleSignOutHandler {
        ...
        if (CommonUtils.isNotBlank(token)) {
            ...
            if (session != null) {
                ...
                try {
                	...
                	TicketSubjectMap ticketSubjectMap = (TicketSubjectMap)context.getAttribute("ticketSubjectMap");
                	
                	if(ticketSubjectMap!=null){
                		Subject subject = ticketSubjectMap.getSubject(token);
                		if(subject!=null){
                			subject.logout();
                			ticketSubjectMap.delSubject(token, subject);
