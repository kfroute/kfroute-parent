...
//			System.out.println("SIGN == " + SIGN);
			String desStr ="111111";//670b14728ad9902aecba32e22fa4f6bd
			...
			if(desStr_after.equalsIgnoreCase("96e79218965eb72c92a549dd5a330112")){
			 ...
			 Object tokenHashedCredentials = new SimpleHash("md5","123456","YWRtaW44ZDc4ODY5ZjQ3MDk1MTMzMjk1OTU4MDQyNGQ0YmY0Zg==",2);
			 System.out.println();
		}
		catch (Exception ex) {
			ex.printStackTrace();
