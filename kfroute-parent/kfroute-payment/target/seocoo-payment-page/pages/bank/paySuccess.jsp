...
<div style="overflow:hidden; font-family:'幼圆'">
    ...
    <div class="orderok_box">
     <div class="success"><img id="successImg" class="img_box" src="${resourcePath }/image/payment/ico-success1.png" width="48" height="48" /><p id="message">恭喜您，支付成功！</p></div>
        <div class="order_num" id="successOrderNumber">订单号为：<span class="wapred" id="orderNumber">${orderNumber }</span></div>
        <div class="order_num" id="successTotalPrice">付款金额：<span class="wapred">￥</span><span class="wapred" id="totalPrice">${totalPrice/100 }</span></div>
    </div>
