...
<html>
	...
	<head>
		...
		<script src="${res}/common/js/m1320/m1320_imp.js" ></script>
 		<script src="${res}/common/css/ajaxfileupload.css" ></script>
	</head>
	<body>
		<form:form method="post" id="imp_form" name ="imp_form" action="${ctx}/m1320/doServerImp.do">
			<!-- 设备信息导入模块 -->
			<div id="server_import">
				<table id="server_imp_tab" class="display cell-border input-table" cellspacing="0" width="100%">
					 <thead>
