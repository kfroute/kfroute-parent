...
<html>
	...
	<head>
		...
		<script src="${res}/common/js/m1310/main.js" ></script>
	...
	<body>
		<div id="contentwrapper">
			    <div class="main_content">
			        <div class="row-fluid">
			            <div class="span12">
			                <h3 class="heading">设备明细列表</h3>
			        		<table class="table table-bordered table_vam display" id="device_detail">
			        			<thead>
			            ...
			            <div class="device_detail_actions">
			                <div class="btn-group">
			                    ...
			                    <ul class="dropdown-menu">
			                        ...
			                        <li><a href="javascript:void(0)" onclick="showBatchUpdateFrame();"><i class="icon-edit"></i> 批量修改</a></li>
			                       <!-- 为防止错误操作，取消批量删除按钮
			                        <li><a href="#" class="delete_rows_dt" data-tableid="device_detail"><i class="icon-trash"></i> 删除</a></li>
			                        -->
